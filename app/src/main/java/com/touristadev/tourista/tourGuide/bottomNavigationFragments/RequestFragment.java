...
import com.touristadev.tourista.tourGuide.adapters.RequestAdapter;
...
public class RequestFragment extends Fragment {
        ...
        public void onViewCreated(View view, @Nullable Bundle savedInstanceState) {
            // Find all the views
            RecyclerView recyclerView = (RecyclerView) view.findViewById(R.id.recyclerListViewRequest);
            ...
            RequestAdapter adapter = new RequestAdapter(getContext(),
                    R.layout.cv_request, mController.getTourRequest());
